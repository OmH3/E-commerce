...
function UpdateProduct() {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        `${import.meta.env.VITE_API_BASE_URL}/product/update-product/${id}`,
        productData
      );
      console.log(data);
      if (data?.success) {
  ...
  const handleDelete = async()=>{
    try{
        ...
        if(!answer) return
        const {data} = await axios.delete(`${import.meta.env.VITE_API_BASE_URL}/product/delete-product/${id}`)
              ...
              <div className="mb-3">
                {photo ? (
                  <div className="text-center">
                    ...
                    <div className="text-center">
                    <img
                      src={`${import.meta.env.VITE_API_BASE_URL}/product/product-photo/${id}`}
                      alt="Product Photo"
                      height={"200px"}
                      width={"200px"}
                    />
